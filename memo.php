...
if ($_SESSION['username'] == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $drug = $_POST['drug'];
        $other = $_POST['other'];
        if(!empty($hn) && !empty($weightbf) && !empty($weight) && !empty($swellid) && !empty($tiredid) && !empty($drugid) && !empty($drug)){
                ...
                <div class="card-body">
                    <form class="row g-3" method="post">
                        <div class="input-group">
                            <input type="hidden" class="form-control" name="hn" id="hn" value="<?php echo $hn; ?>" disabled >
                            <input type="hidden" class="form-control" name="weightbf" id="weightbf" value="<?php echo $weightbf; ?>" disabled >
                        </div>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-xs-auto">
                            ...
                            <select class="form-select" id="checkdrugid" name="drugid" class="selectpicker" data-live-search="true" >
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-xs-auto">
                            ...
                            <input type="text" class="form-control" id="checkdrug" name="drug" disabled >
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            while ($row =  $swelltype->fetch_array()) { ?>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="swellid" id="swellid" value="<?php echo $row['swellid']; ?>" >
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-xs-auto">
                            ...
                            while ($row = $question->fetch_array()) { ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tiredid" id="tiredid" value="<?php echo $row['tiredid']; ?>" >
