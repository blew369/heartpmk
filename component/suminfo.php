<div class="card-header text-center text-white bg-cyan">
    สรุปผลการกรอกแบบฟอร์ม
</div>
<img src="cardimg/info.png" class="card-img-top" alt="...">
<div class="card-body">
    ...
    <div class="alert alert-info" role="alert">
        ...
        <p style="font-size:14px;">ปฏิบัติตามคำแนะนำและปรับจำนวนยาขับปัสสาวะลดลง</p>
