...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2023 at 08:27 AM
...
--
ALTER TABLE `heartrequest`
  MODIFY `reid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT for table `members`
--
ALTER TABLE `members`
  MODIFY `memberid` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
