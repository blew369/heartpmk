...
if ($_SESSION['usereq'] == "") {
    ...
    if ($_POST['datef'] && $_POST['datel'] != '' && $_POST['hn']) {
        ...
        $hn = $_POST['hn'];
        $requestpatient = $conDB->RequestFilterbyHn($hn,$datefirst,$datelast);
    } else {
    ...
    <body>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Request <small>Patients</h1>
                <!-- end page-header -->
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">ประวัติกาทำรายของผู้ป่วย(แยกตามผู้ป่วย)</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        <table id="data-table-default" class="table table-striped table-bordered mt-5">
                            ...
                            <tbody>
                                <?php
                                if ($requestpatient->num_rows > 0) {
                                    while ($row = $requestpatient->fetch_assoc()) {
                                        $date = $row['reqdate'];
