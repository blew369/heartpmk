...
?>
    ...
    <head>
        <meta charset="utf-8" />
        <title>ดูประวัติการทำรายการของผผู้ป่วยทั้งหมด</title>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">Request Filter</li>
                </ol>
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Request <small>All-Patients</small></h1>
                <!-- end page-header -->
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">ดูประวัติการทำรายการของผผู้ป่วยทั้งหมด</h4>
                    </div>
                    <div class="panel-body">
                        <div class="container">
                            <form name="reportdate" method="post" action="request_filter_then.php" target="_blank">
                                <div class="row">
                                    <div class="col-md-1">
                                    </div>
                                    <div class="col-md-5">
