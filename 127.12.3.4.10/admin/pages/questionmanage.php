		...
		<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
			...
			<div id="content" class="content">
				...
				<ol class="breadcrumb pull-right">
					...
					<li class="breadcrumb-item active">Questions Managed Tables</li>
				</ol>
				<!-- end breadcrumb -->
				<!-- begin page-header -->
				<h1 class="page-header">จัดการคำถาม</h1>
				<!-- end page-header -->
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-heading bg-inverse">
						...
						<h4 class="panel-title">ข้อมูลคำถาม</h4>
					</div>
					<!-- end panel-heading -->
					<!-- begin panel-body -->
					<div class="panel-body" id="patient">
						<div class="mb-3" align="left">
							<button onclick="document.getElementById('tdid').value = ''" type="button" name="add" id="add" data-toggle="modal" class="btn btn-green" data-target="#addModal"><i class="fas fa-plus-circle"></i> เพิ่มคำถาม</button>
						</div>
						<table id="data-table-default" class="table table-striped table-bordered mt-5">
							<thead>
								<tr>
									<th width="10%" class="text-nowrap">คำถาม</th>
							...
							<tbody>
								<?php
								$result = $conDB->fetchAllquestion();
								while ($row = $result->fetch_assoc()) {
								?>
									<tr class="odd gradeX">
										<td width="10%"><?php echo $row['question']; ?></td>
										<td width="10%"><?php echo $row['tiredname']; ?></td>
										<td width="1%"><button type="button" name="edit" value="edit" class="btn btn-warning btn-sm edit_data" id="<?php echo $row['tdid']; ?>"><i class="fas fa-edit"></i> แก้ไข</button></td>
										<td width="1%"><button type="button" name="delete" value="delete" class="btn btn-danger btn-sm delete_data" id="<?php echo $row['tdid']; ?>"><i class="fas fa-window-close"></i> ลบ</button></td>
									</tr>
								<?php
								...
								<div class="modal-body">
									<form method="post" id="insert_form">
										<div class="form-group col-mb-3">
											...
											<label for="question" class="form-label mt-2">คำถาม</label>
											<input type="text" class="form-control" name="question" id="question" required>
										</div>
										<div class="form-group col-mb-3">
											<label for="tiredid" class="form-label mt-2">ระดับอาการเหนื่อย</label>
			...
			<script>
				$(document).ready(function() {
					...
					$('.delete_data').click(function() {
						...
						var status = confirm("คุณต้องการลบคำถามใช่หรือไม่?");
						if (status) {
							$.ajax({
								url: "../class/questionDelete.php",
								method: "post",
								data: {
									id: tdid
								},
